    ...
    internal class Program
    {
        static void Main()
        {
            ...
            while (continueRunning)
            {
                ...
                Console.WriteLine("9. Display Highest Scores");
                Console.WriteLine("10. Display Lowest Scores");
                Console.WriteLine("11. Calculate and Display Average");
                ...
                if (int.TryParse(Console.ReadLine(), out choice))
                {
                    switch (choice)
                    {
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            matchManagement.DisplayHighestScores();
                            break;
                        case 10:
                            matchManagement.DisplayLowestScores();
                            break;
                        case 11:
                            matchManagement.CalculateAndDisplayAverageScores();
                            break;
                        case 0:
